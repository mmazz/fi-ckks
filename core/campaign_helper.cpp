...
void print_usage(const char* program_name) {
    ...
    std::cout << "Usage: " << program_name << " [OPTIONS]\n\n"
              ...
              << "  --logSlots <value>      log Slots used (default: logN - 1)\n"
              << "  --mult_depth <value>    Multiplicative depth (only openfhe, default: 0)\n"
              << "  --withNTT <value>       Inject in NTT (evaluation) form (only openfhe, default: 0)\n"
              << "  --op_depth <value>      Which occurrence of the op the fault lands on (0-based, default: 0)\n"
              << "  --op_step <value>       Which internal step of that op (0-based, default: 0)\n"
              << "  --pipeline <str>        Pipeline of the server, ej: \"add; mul x2; rot 4\" (must be empty for the NN workloads)\n"
              ...
              << "  --attackModeSKA <value> SDC detector mode (only openfhe, default: complete)\n"
              << "  --thresholdSKA <value>  SDC detector threshold in bits (only openfhe, default: 5.0)\n"
